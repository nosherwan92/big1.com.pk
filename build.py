...
.svc-panel h3{font-size:clamp(.98rem,1.45vw,1.22rem);line-height:1.35;letter-spacing:-.01em;
  font-weight:560;margin:0 0 8px;color:var(--emerald-300,#6EE7B7);text-wrap:balance}
