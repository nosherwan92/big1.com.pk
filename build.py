...
.rhero-ov{position:absolute;inset:0;z-index:-1;
  background:linear-gradient(100deg,rgba(3,24,18,.80) 0%,rgba(4,40,30,.58) 42%,rgba(4,30,22,.26) 78%,rgba(4,30,22,.12) 100%)}
/* The overlay was lightened so the photograph is actually visible. That costs contrast
   where the copy sits, so the copy carries its own local scrim instead of darkening the
   whole frame: measured back above 4.5:1 on every slide (scratchpad/contrast.py). */
.rhero-inner::before{content:"";position:absolute;left:-4vw;top:0;bottom:0;
  width:min(880px,72%);z-index:-1;pointer-events:none;
  background:linear-gradient(100deg,rgba(2,18,13,.66) 0%,rgba(2,18,13,.44) 48%,rgba(2,18,13,.14) 80%,transparent 100%)}
