...
<section class="hero">
  <div class="hero-bg" aria-hidden="true">
    <div class="aurora a1" data-par="0.035"></div><div class="aurora a2" data-par="-0.028"></div>
    <div class="aurora a3" data-par="0.02"></div><div class="grid-lines"></div>
  </div>
  <div class="wrap">
    <div class="hero-grid">
      <div class="hero-copy">
        ...
        <div class="hero-meta" data-reveal style="--d:340ms">
          <div><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> Filed via an authorized FBR e-intermediary</div>
          <div><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> One team for FBR, SECP &amp; IPO Pakistan</div>
          <div><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> Available in English &amp; &#1575;&#1585;&#1583;&#1608;</div>
        </div>
      </div>
