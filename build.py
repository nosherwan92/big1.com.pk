...
<section class="rhero" id="rhero">
  <div class="rhero-slides" aria-hidden="true">
    <!-- The photograph is the design and always renders. Over it, where it is affordable,
         plays hero-1-ledger.mp4: scattered figures easing into a clean ledger column -- the
         thing the product does, generated by us rather than bought as footage. -->
    <div class="rslide on rslide-vid" style="background-image:url(\'assets/hero-1-tax.jpg\')">
      <video class="rvid" muted playsinline preload="none" loop aria-hidden="true"
             poster="assets/hero-1-tax.jpg" data-src="assets/hero-1-ledger.mp4"></video>
    </div>
