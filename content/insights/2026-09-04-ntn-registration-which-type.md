---
title: NTN registration: individual, business, AOP or company?
category: Registrations
date: 2026-09-04
image: assets/ins-ntn.webp
...
For a person: salaried, retired, or with personal income such as rent or savings.

For an individual, the CNIC is the NTN. Registration is really the creation of your IRIS profile against it. If you are salaried and have never filed, this is almost certainly what you need.
...
For two or more people in business together under a partnership deed or arrangement.

The AOP registers in its own name and files its own return, and the partners' shares also appear in their personal returns. This is the one people most often get wrong: two brothers running a shop together are usually an AOP, not one man's sole proprietorship.
...
For an individual: CNIC, a mobile number registered in your own name, and an email address. FBR sends a verification code to that number, which is why it must be yours.

A business, AOP or company adds proof of premises, the business or entity documents, and the details of the people behind it. We list the exact set for your case before you start, and we can handle the registration for you.
